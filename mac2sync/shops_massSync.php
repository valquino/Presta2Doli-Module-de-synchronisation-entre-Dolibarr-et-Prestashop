...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	print '<div>';
	print '<b><u>Synchroniser vers catégorie existante:</u></b>';
	...
	//Affichage des catégories Dolibarr
	...
	//Récupération des catégories Prestashop
	...
	//Affichage des catégories Prestashop
	...
	print '<b><u>Synchroniser vers nouvelle catégorie (en cours de dev):</u></b>';
	print '<div>';
	...
	print '<b><u>Synchroniser les catégories Prestashop vers Dolibarr:</u></b>';
	print '<input type=hidden value="'.$id.'" name="id">';
	print '<input type=hidden value="'.$id.'" name="shop_id">';
	...
	print '<b><u>Synchroniser les catégories Dolibarr vers Prestashop:</u></b>';
	print '<input type=hidden value="'.$id.'" name="id">';
	print '<input type=hidden value="'.$id.'" name="shop_id">';
	...
	if($action == 'SYNC_ALL_CATE'){
		global $db;
		echo "<b><u>Catégories synchronisées: </b></u><br>";
