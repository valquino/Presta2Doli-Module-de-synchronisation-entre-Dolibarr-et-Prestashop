...
/**
 *  \file       mac2sync/myobject_contact.php
 *  \ingroup    mac2sync
...
dol_include_once('/mac2sync/class/myobject.class.php');
dol_include_once('/mac2sync/lib/mac2sync_myobject.lib.php');
...
$permission = $user->rights->mac2sync->myobject->write;
...
if ($object->id)
{
	...
	$linkback = '<a href="'.dol_buildpath('/mac2sync/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
