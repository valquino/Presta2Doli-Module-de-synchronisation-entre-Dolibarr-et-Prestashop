...
// var_dump($object->fields['ENTITY_CONNEXION']['arrayofkeyval']);
// exit;
	...
	if (!empty($val['noteditable'])) {
		...
		if ($key == 'lang') {
			...
			if($key == 'ENTITY_CONNEXION'){
				print $form->multiselectarray('ENTITY_CONNEXION',$object->fields['ENTITY_CONNEXION']['arrayofkeyval'],GETPOST('ENTITY_CONNEXION', ''),'', 0, 'quatrevingtpercent widthcentpercentminusx', 0, 0);
			}else{
