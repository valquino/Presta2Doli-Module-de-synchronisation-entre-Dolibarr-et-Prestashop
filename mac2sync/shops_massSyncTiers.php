...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	print dol_get_fiche_head($head, 'massSyncTiers', $langs->trans("Shops"), -1, $object->picto);
	...
	print '<div>';
	print '<b><u>Importer les Tiers Doli -> Presta :</u></b>';
	...
	if($action == 'SYNC_TIERS'){
		...
		$object->syncAllTiers($prestashop_api_key, $prestashop_url);
	}
