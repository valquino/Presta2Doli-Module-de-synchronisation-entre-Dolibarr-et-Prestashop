...
/**
 *  \file       shops_contact.php
 *  \ingroup    mac2sync
 *  \brief      Tab for contacts linked to Shops
 */
...
$hookmanager->initHooks(array('shopscontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Shops')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id)
{
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Shops"), -1, $object->picto);
