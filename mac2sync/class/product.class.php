 ...
 */
// require_once DOL_DOCUMENT_ROOT.'/custom/mac2Sync/core/lib/product.lib.php';
require_once DOL_DOCUMENT_ROOT.'/custom/mac2sync/class/commonObjectMac2sync.class.php';
 ...
 */
class ProductMac2sync extends CommonObjectMac2sync
{
	/**
	...
	// [CCE] 
	public function getCoefFixe(){
		global $db;
		$sql = "SELECT coef_fixe FROM `llx_product` WHERE `rowid` = $this->id ";
		$res = $db->query($sql);
		$coefFixe = $db->fetch_row($res);
		$coefFixe = $coefFixe[0];
		return $coefFixe;
	}
}
 ...
 */
class ProductServiceMac2sync extends Product
{
