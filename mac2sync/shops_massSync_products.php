...
dol_include_once('/mac2sync/class/mac2sync_products.class.php');
...
$object 				= new Mac2SyncProducts($db);
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create')))
{
	...
	print dol_get_fiche_head($head, 'massSyncProducts', $langs->trans("Shops"), -1, $object->picto);
	...
	print '<div>';
	print '<b><u>Importer les Produits Presta -> Doli :</u></b>';
	...
	print '<input type=hidden value="SYNC_PRODUCTS" name="action">';
