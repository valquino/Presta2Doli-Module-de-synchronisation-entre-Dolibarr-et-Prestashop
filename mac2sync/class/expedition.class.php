 ...
 */
class ExpeditionMac2sync extends CommonObject
{
	use CommonIncoterm;
	 ...
	 */
    public function create($user, $entity, $notrigger = 0)
	{
    ...
    // /**
	//  *  Load an object from an order and create a new shipment into database
	//  *
