...
/**
 * \file    test/phpunit/Mac2SyncFunctionalTest.php
 * \ingroup mac2sync
 ...
 *
 * @package Testmac2sync
 */
class Mac2SyncFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/mac2sync/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mac2sync/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mac2sync/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mac2sync/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mac2syncwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMac2Sync_Mac2SyncTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMac2Sync_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
